  ...
  return (
    <main className="anime-page">
      ...
      <header className="anime-header">
        <a className="anime-brand" href="#top"><span className="anime-brand-mark">潮</span><span><strong>BLUE WHALE GAME</strong><small>ANIME VIDEO ROOM</small></span></a>
      ...
      <section id="top" className="anime-hero">
        ...
        <div className="anime-copy">
          <p className="anime-kicker"><Sparkles size={14} /> BLUE WHALE GAME / ANIME VIDEO</p>
          <h1>Blue<br /><span>Whale.</span></h1>
        ...
        <div className="anime-video-column">
          <div className="video-label"><span>VIDEO FILE / 00:09</span><span>BLUE WHALE GAME ARCHIVE</span></div>
      ...
      <section className="anime-footer-panel"><div className="panel-kanji">海</div><div><p className="panel-label">BLUE WHALE GAME / VISUAL ROOM</p><p className="panel-copy">One video. One ocean. Press play when you are ready.</p></div><div className="panel-coordinate">35° 41′ N<br />139° 41′ E</div></section>
      <footer className="anime-footer"><span>© BLUE WHALE GAME ARCHIVE</span><span>KEEP THE CURRENT MOVING</span></footer>
    </main>
  );
}
